...
export default function Settlement({ onSettlementSubmit }) {
    const [balances, setBalances] = useState({ s: 0, u: 0, k: 0, i: 0, sc: 0 });

    useEffect(() => {
        onSettlementSubmit(balances);
    }, [balances]);
    ...
    return (
        <div className="bg-white shadow-md p-4 rounded-lg mb-4">
            <h2 className="text-xl font-semibold mb-2">Adjust Balances After Settlement</h2>
